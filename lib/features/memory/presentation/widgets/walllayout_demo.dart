...
class WallLayoutDemo extends StatefulWidget {
  WallLayoutDemo({Key key, this.title = 'Wall Layout Demo'}) : super(key: key);

  final String title;

  @override
  _WallLayoutDemoState createState() => _WallLayoutDemoState();
}

class _WallLayoutDemoState extends State<WallLayoutDemo>
